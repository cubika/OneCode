========================================================================
                 控制台应用程序: CSAutomateWord 项目概述
========================================================================

/////////////////////////////////////////////////////////////////////////////
摘要:

CSAutomateWord案例阐述了如何使用Visual C#代码生成Microsoft Word 实例，构建新的Word文档，插入
段落、表格，保存文档，关闭Word应用程序及释放非托管COM资源的过程。 
...
步骤1. 在Visual Studio 2008中成功建立示例项目后，将获得名为CSAutomateWord.exe的应用程序。
