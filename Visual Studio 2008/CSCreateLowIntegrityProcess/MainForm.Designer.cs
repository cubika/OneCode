namespace CSCreateLowIntegrityProcess
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.btnCreateLowProcess.Text = "以低完整级别执行本程序";
            ...
            this.btnWriteLocalAppData.Text = "写入LocalAppData文件夹";
            ...
            this.btnWriteLocalAppDataLow.Text = "写入LocalAppDataLow文件夹";
