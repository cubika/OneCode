========================================================================
     网站 程序 : VBADONETDataService 项目 概述
========================================================================
...
A. 创建一个普通的ASP.NET 网站项目
   ...
   1. 在 Visual Studio 2008中添加一个新的ASP.NET 网站项目。(Visual Basic.Net->Web->ASP.NET Web Application),
      命名为 VBADONETDataService。
...
C. 创建一个基于 LINQ to SQL Classes 的 ADO.NET Data Service。
   ...
   2. 实现 IUpdatable 接口来允许 LinqToSQL DataContext Class 的增删改。
      ...
      2) 添加下载的 IUpdatableLinqToSQL.vb 到 LinqToSQL 文件夹, 修改 DataContext class， 
