...
Partial Class MainForm
    ...
    Private Sub InitializeComponent()
        ...
        Me.btnWriteLocalAppDataLow.Text = "写入LocalAppDataLow文件夹"
        ...
        Me.btnWriteLocalAppData.Text = "写入LocalAppData文件夹"
        ...
        Me.btnCreateLowProcess.Text = "以低完整级别执行本程序"
