========================================================================
    WIN32 应用程序：CppCreateLowIntegrityProcess项目概述
========================================================================
...
CppCreateLowIntegrityProcess.exe. 
...
步骤3、点击 [以低完整级别执行本程序]按钮。一个新的CppCreateLowIntegrityProcess
...
示例中的GetProcessIntegrityLevel函数演示了如何获取当前进程的完整性级别。
  ...
  1）以TOKEN_QUERY开启此线程的主访问令牌。
  
  2）使用GetTokenInformation从主访问令牌中获取TokenIntegrityLevel信息。
