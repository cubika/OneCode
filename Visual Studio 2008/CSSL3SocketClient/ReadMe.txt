========================================================================
    SILVERLIGHT应用程序: CSSL3SocketClient项目概述
========================================================================

/////////////////////////////////////////////////////////////////////////////
用法:

本项目创建一个套接字客户端示例，它能异步发送字符串消息到服务器和从服务器接收字符串消息。
...
项目CSSL3SocketServer是能为Silverlight套接字客户端服务的套接字服务器。 
...
要运行这个套接字示例，请尝试以下步骤：
1. 运行套接字socket服务器
	a. 用管理员身份打开CSSLSocketServer解决方案，并编译。
	b. 运行该项目。
2. 运行silverlight套接字客户端
	a. 打开CSSL3Socket解决方案，并编译。
...
1. 怎样使用套接字同步连接套接字服务器？
    ...
    此代码示例在SocketClient.cs中的"Socket async connect"代码块中可找到。
...
2. 怎样从字串消息中分离出套接字字节数组？
    ...
    此代码示例在SocketClient.cs中的"String Decoding"代码块中可找到。
...
3. 怎样通过套接字接收字符串？
    ...
    此代码示例在SocketClient.cs中的"Socket async Receive"代码块中可找到。
...
4. 怎样通过套接字发送字符串？
    ...
    此代码示例在SocketClient.cs中的"Socket async Send"代码块中可找到。
