========================================================================
            VBASPNETEmailAddressValidator 项目概述
========================================================================
...
步骤 1: 打开VBASPNETEmailAddressValidator.sln.

步骤 2: 展开VBASPNETEmailAddressValidator网站的结点并按下 
...
步骤 1.  在Visual Studio 2010或者是Visual Web Developer 2010中新建一个VB 
         "ASP.NET空网络应用程序". 命名为"VBASPNETEmailAddressValidator".
...
步骤 5.  新建一个类文件, 命名为EmailValidation.vb. 按照示例写出代码, 我们可以在
         示例文件的注释中找到更多的细节.
...
步骤 8.  打开Default.aspx.vb文件. 根据示例写出代码. 你可以可以在示例
         文件中的注释中找到更多的细节.
