========================================================================
  ASP.NET 应用程序 :  CSASPNETInfiniteLoading 项目概述
========================================================================
...
的页面预先取内容,并且把它直接添加到用户的当前页面. 这个代码实例演示了
把大量数据全部加载到一个XML文件中. 它使用了AJAX技术支持无限滚动. 


/////////////////////////////////////////////////////////////////////////////
代码演示： 

直接打开CSASPNETInfiniteLoading.sln,展开应用程序的节点并按下F5来测试应用程序. 
...
步骤1.  在Visual Studio 2010创建一个C# ASP.NET空应用程序. 
