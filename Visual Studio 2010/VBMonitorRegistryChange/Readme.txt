================================================================================
       Windows应用程序: VBMonitorRegistryChange 项目概述                        
===============================================================================
/////////////////////////////////////////////////////////////////////////////
摘要:
本示例阐述了如何使用WMI事件监控注册表项变更事件。当下面的操作发生时，变更事件会被引发。
1 重命名或删除项。
2 添加，重命名或删除一个项下面的子项。
3 添加，重命名或删除一个项的值。
...
步骤5 在注册表编辑器中，导航到HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft。右键点击这一项
并创建一个新的项。你会在list box中看到一个新的子项目“项 HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft 
发生变化”。
