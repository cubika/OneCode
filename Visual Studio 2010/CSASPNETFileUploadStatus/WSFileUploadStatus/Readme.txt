...
步骤1. 建一个名为"WSFileUploadStatus"的网站.

步骤2. 在浏览器中查看Default.aspx页.

步骤3. 选择一个你想用来测试这个例子的文件.

步骤4. 单击上传按钮.你将会看到上传状态的详细信息.

/////////////////////////////////////////////////////////////////////////////
代码逻辑:

步骤1.  在Visual Studio 2010或者Visual Web Developer 2010中创建一
个C#代码项目把它命名为FileUploadStatus.

步骤2.  在项目中添加两个引用, System.Web.Extension 和 System.Web.

步骤3.  在例子文件夹"FileUploadStatus"中复制UploadStatus.cs
的代码.

步骤4.  添加一个ASP.NET模块并且把它命名为UploadProcessModule.

步骤5.  在例子的文件夹"FileUploadStatus"中复制UploadProcessModule.cs
的代码.

步骤6.  还要创建文件: BinaryHelper.cs, UploadFile.cs, 
UploadFileCollection.cs 和 FileUploadDataManager.cs, 并且复制他
们的代码.
