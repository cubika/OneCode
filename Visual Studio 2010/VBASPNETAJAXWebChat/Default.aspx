<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Default.aspx.vb" Inherits="VBASPNETAJAXWebChat._Default" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>VBASPNETAJAXWebChat</title>
    ...
    <div>
        ...
        <fieldset>
            ...
            <asp:Panel runat="server" ID="PnlControlPanel" Style="padding: 10px;">
                <asp:Label ID="lblAlias" runat="server" Text="你的昵称:"></asp:Label><asp:TextBox
