...
<body>
    ...
    <div style="text-align: center">
        <table style="width: 50%">
            <tr>
                <td>
                    <asp:Label ID="lbUserName" runat="server" Text="用户名:"></asp:Label><asp:TextBox
                        ID="tbUserName" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="lbTrueName" runat="server" Text="真名:"></asp:Label><asp:TextBox
            ...
            <tr>
                <td style="text-align: center">
                    ...
                    <asp:Label ID="lbMessage" runat="server" Text="标签" Visible="False" ForeColor="Red"></asp:Label>
                </td>
            </tr>
        </table>
    </div>
