=============================================================================
            VBASPNETHighlightCodeInPage 项目 概述
=============================================================================

/////////////////////////////////////////////////////////////////////////////
用法:

有时候我们输入类似VB或HTML代码后,需要高亮这些代码以获得一个更好的阅读体验.
这个项目演示了如何在一个页面中高亮代码. 
...
步骤1: 在Visual Studio 2010中创建一个空白VB ASP.NET Web应用程序.

步骤2: 在Visual Studio 2010新增一个VB类文件,命名为'CodeManager'.
在这个文件中,我们使用散列表的变量来存储不同语言的代码及相关配套选项.
然后添加正则表达式样式对象到代码匹配的字符串.
你可以在CodeManager.vb文件中找到完整的代码.
...
步骤5: 打开页面后台VB代码编写代码高亮的功能。
您可以在HighlightCodePage.aspx.vb文件找到完整版本.
