    ...
    <div>
        ...
        <RowStyle BackColor="White" ForeColor="#003399" />
            <Columns>
                ...
                <asp:TemplateField HeaderText="姓" SortExpression="LastName">
                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="名" SortExpression="FirstName">
                    <EditItemTemplate>
        ...
        <asp:Panel ID="pnlAdd" runat="server" Visible="False">
            ...
            <br />
            <br />
            <asp:LinkButton ID="lbtnSubmit" runat="server" onclick="lbtnSubmit_Click">递交</asp:LinkButton>
            &nbsp;&nbsp;&nbsp;
