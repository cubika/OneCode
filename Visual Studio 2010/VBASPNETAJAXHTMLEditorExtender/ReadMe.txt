...
步骤 1: 打开VBASPNETHTMLEditorExtender.sln.
...
步骤 2.  在Visual Studio 2010或Visual Web Developer 2010中创建VB.NET "Class Library" 项目. 
...
步骤 10. 在ToolBar_buttons文件夹中创建一个类文件,称为H1.vb.

步骤 11. 编写为按钮注册服务器端类代码.参照示例文件H1.vb.

步骤 12. 在项目根目录创建一个新类, 称为MyEditor.vb.
...
步骤 14. 创建一个新的VB.Net "Web Site", 改变最后的文件夹名为TestWebSite.
