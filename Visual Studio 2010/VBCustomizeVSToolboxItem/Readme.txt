================================================================================
		Visual Studio Package项目: VBCustomizeVSToolboxItem                        
===============================================================================
...
步骤2. 打开该项目的属性页并选择Debug栏目。设置start option
       为Start external program并浏览选中devenv.exe(默认路径
...
步骤5. 在VS的试验实例中，新建一个解决方案或打开一个已存在的
       解决方案并开始编辑一个.txt文件。

	     
步骤6. 打开工具箱窗口，你将会发现一个新的栏目叫作："VB Custom Toolbox Tab"
       和一个"VB Custom Toolbox Item"条目。把鼠标指针移到这个条目上，你会看到
       下面的提示信息：
          
           VB Custom Toolbox Tooltip
           VB Custom Toolbox Description

步骤7. 拖拽这个新的工具箱控件放到.txt文件中，"vb hello world"将被添加到文件中。	
...
B. 在VBCustomizeVSToolboxItemPackage中重写Initialize方法。
