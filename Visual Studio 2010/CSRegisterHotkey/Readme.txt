=============================================================================
       Windows应用程序: CSRegisterHotkey 项目概述                        
=============================================================================
/////////////////////////////////////////////////////////////////////////////
摘要:

CSRegisterHotkey案例阐述了如何给当前应用程序注册和注销一个热键。
...
步骤1. 用VS2010建立CSRegisterHotkey 项目. 

步骤2. 运行CSRegisterHotkey.exe.
...
1. 定义一个类HotKeyRegister覆盖User32.dll的两种外来方法RegisterHotKey和Unregister-
   ...
   当用参数的处理、地址、修改器和关键词的方式处理该类的一个新的实例时，构造函数将声
