            ...
            <tr>
                ...
                <td>
                    <asp:Panel ID="pnlSearch" runat="server" DefaultButton="btnLocation">
                        ...
                        <br />
                        <asp:Button ID="btnLocation" runat="server" Text="提交查询" OnClientClick="FindLoc();return false;" />
                    </asp:Panel>
                    <br />
                    <asp:Panel ID="pnlDisplayOption" runat="server">
                        ...
                        <asp:RadioButtonList ID="rdlViewStyle" runat="server" RepeatDirection="Horizontal"
                            RepeatLayout="Flow">
                            <asp:ListItem Selected="True" onclick="SetStyle('r')">路径模式</asp:ListItem>
                            <asp:ListItem onclick="SetStyle('a')">卫星模式</asp:ListItem>
                        </asp:RadioButtonList>
                        <br />
                        缩放等级:
                        ...
                        <asp:Panel ID="pnlLatLng" runat="server" DefaultButton="btnLatLng">
                            ...
                            <br />
                            <asp:Button ID="btnLatLng" runat="server" Text="提交查询" OnClientClick="SetMap();return false;" />
                        </asp:Panel>
                    </asp:Panel>
                    <br />
                </td>
