...
<body>
    ...
    <div>
        <table style="font-family: Calibri; width: 100%">
            <tr>
                <td>
                    <asp:Label ID="lbwords" runat="server" Text="输入一些文字:"></asp:Label>
                </td>
                <td colspan="3">
            ...
            <tr>
                <td>
                    <asp:Label ID="lbEncryptData" runat="server" Text="加密数据:"></asp:Label>
                </td>
                <td>
                    <asp:Button ID="btnEncrypt" runat="server" Text="加密" OnClick="Encrypt_Click"
                ...
                <td>
                    <asp:Label ID="lbDecryptedData" runat="server" Text="解密数据:"></asp:Label>
                </td>
                <td>
                    <asp:Button ID="btnDecrypt" runat="server" Text="解密" OnClick="Decrypt_Click"
                        Height="30px" Width="90px" />
                    <br />
