...
步骤1. 在您成功地在Visual Studio 2010 （针对任意平台）编译后，您将会获得一个应用程序VBPlatformDetector.exe. 
...
.用把这个进程ID作为第一个参数运行VBPlatformDetector.exe，例如：
...
Win32_OperatingSystem.Caption值的找到VB代码.
