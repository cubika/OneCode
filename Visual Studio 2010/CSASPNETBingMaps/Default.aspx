            ...
            <tr>
                ...
                <td>
                    <asp:Panel ID="pnlSearch" runat="server" DefaultButton="btnLocation">
                        ...
                        <br />
                        <asp:Button ID="btnLocation" runat="server" Text="提交查询" 
                            OnClientClick="FindLoc();return false;" />
                    </asp:Panel>
                    <br />
                    <asp:Panel ID="pnlDisplayOption" runat="server">
                        ...
                        <asp:Panel ID="pnlLatLng" runat="server" DefaultButton="btnLatLng">
                            ...
                            <br />
                            <asp:Button ID="btnLatLng" runat="server" Text="提交查询" 
                                OnClientClick="SetMap();return false;" />
                        </asp:Panel>
                    </asp:Panel>
                    <br />
                </td>
