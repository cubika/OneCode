========================================================================
          VBASPNETAJAXConsumeExternalWebService 概述
========================================================================
...
步骤 1: 打开VBASPNETAJAXConsumeExternalWebService.sln.
...
步骤 1.  在Visual Studio 2010或Visual Web Developer 2010中创建一个
	VB "ASP.NET空白Web站点".变更最后的文件夹名为ExternalWebSite.

步骤 2.  增加一个新"Web服务"项目.我们叫它ExternalWebService.asmx.

步骤 3.  打开App_Code中的ExternalWebService.asmx.vb.
...
步骤 7.  增加一个VB "ASP.NET空白Web站点".变更最后的文件夹名为TestWebSite.
...
步骤 11. 在App_Code中打开BridgeWebService.asmx.vb. 重复步骤4.
