========================================================================
  ASP.NET 应用程序 : CSASPNETRemoteUploadAndDownload 概述
========================================================================
/////////////////////////////////////////////////////////////////////////////
用法:

CSASPNETRemoteUploadAndDownload示例演示在ASP.NET中如何上传下载文件自远程服务器. 

本示例建立于使用C#语言中的WebClient和FtpWebRequest对象. 
...
1.打开CSRemoteUploadAndDownload.sln文件.
