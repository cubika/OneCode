========================================================================
              VBASPNETImagePreviewExtender 项目概述
========================================================================
...
步骤 1. 在 Visual Studio 2010 或 Visual Web Developer 2010中创建一个
	VB "ASP.NET AJAX 扩展程序控件" 项目.
	将其命名为ImagePreviewExtender.

步骤 2. 我们可以看到有三个文件被创建了. 一个.JS文件, 一个.vb文件和 
	一个.RESX 文件. 删除.RESX文件, 在此示例中我们不需要它.
	重命名js文件为ImagePreviewBehavior.js.
	重命名vb文件为ImagePreviewControl.vb.

步骤 3.  打开ImagePreviewControl.vb.
...
步骤 5.  打开"My Project"文件夹中的AssemblyInfo.vb.在文件底部,创建两个web资源定义. 
我们可以下载一个关闭图标并复制到根目录.  
