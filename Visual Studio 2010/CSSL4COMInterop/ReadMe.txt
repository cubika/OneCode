========================================================================
    SILVERLIGHT 应用程序 : CSSL4COMInterop 项目概述
========================================================================
...
1.  使用评估许可在本地计算机安装silverlight应用程序.
    a. 打开CSSL4COMInterop解决方案并编译.
	b. 运行这个项目.
	c. 在浏览器中右击silverlight应用程序，选择“在本机安装CSSL4COMInterop应用程
	   序...”，然后在弹出的面板中单击“安装”按钮.
2.  在OOB模式下测试该应用程序
    a. 双击桌面快捷键“CSSL4COMInterop应用程序”启动这个应用程序.
	b. 通过操纵数据表格编辑数据.
	c. 点击按钮将数据导出到不同的应用程序.
