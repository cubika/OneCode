...
步骤1: 打开 VBASPNETPrintPartOfPage.sln.

步骤2: 展开VBASPNETPrintPartOfPage应用程序并按下Ctrl + F5来运行Default.aspx.         
...
步骤1. 在Visual Studio 2010或Visual Web Developer 2010中创建一个VB的"ASP.NET空应用程序". 
        把它命名为"VBASPNETPrintPartOfPage". 
