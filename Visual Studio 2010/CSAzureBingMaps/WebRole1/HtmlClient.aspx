...
<head runat="server">
    ...
    <li>
        <div class="ItemContainer" onclick="SelectItem(this)">
            ...
            <div>位置: ${Value.Latitude}, ${Value.Longitude}</div>
            <div>时间: <input type="text" class="DatePicker" value="${formatDate(Value.Time)}" readonly/></div>
            <input type="button" value="删除" onclick="DeleteItem(this)"/>
...
<body>
    ...
    <asp:HyperLink ID="LoginLink" runat="server" NavigateUrl="LoginPage.aspx?returnpage=HtmlClient.aspx" Text="管理您自己的旅途请先登录." />
    <asp:Label ID="UserNameLabel" runat="server" />
    <div id="ErrorInformation"></div>
    <div id="OperationsArea">
        <input id="DataButton" type="button" value="保存" onclick="SaveListButton_Click()" />
        <ul id="TravelList" />
    </div>
    <div id="MapArea">
